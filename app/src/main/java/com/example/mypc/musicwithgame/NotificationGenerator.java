package com.example.mypc.musicwithgame;

/**
 * Created by MyPC on 04/01/2018.
 */
...
import com.example.mypc.musicwithgame.View.Music_Player_Activity;
...
public class NotificationGenerator {
    ...
    public static void openActivityNotification(Context context){
        ...
        Intent notifyIntent = new Intent(context, Music_Player_Activity.class);
